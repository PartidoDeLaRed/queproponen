...
Propuesta("Plan para resolver la crisis habitacional","Estructura estatal capaz de planificar y ejecutar políticas públicas de vivienda y hábitat que tiendan a resolver la crisis habitacional local: Ministerio de vivienda y hábitat; Banco de vivienda y hábitat (para centralizar y administrar los fondos necesarios); unidades comunales, donde los ciudadanos participen en pos de construir soluciones viables para resolver la problemática habitacional; Instituto de Registro de Inmuebles, donde se observen casos de ociosidad, cobrándoseles altos impuestos; Polo Centralizado de Monitoreo y Régimen de Selección de Aspirantes, para transparentar los procesos de adjudicación de viviendas construidas.", temas.PLANEAMIENTO_URBANO, 0, 5),
Propuesta("Garantizar la accesibilidad, universalidad, gratuidad y excelencia del servicio de salud pública de la Ciudad.", "", temas.SEGURIDAD, 0, 5),
Propuesta("Participación activa del Estado en cuanto a conducir, regular y acreditar al Sistema de Salud de la Ciudad en forma integral (sector público estatal, seguridad social y privado).", "", temas.SEGURIDAD, 0, 5),
Propuesta("Producción pública de medicamentos.", "", temas.SEGURIDAD, 0, 5),
Propuesta("Creación del Instituto de Fiscalización y Control Sanitario.", "", temas.SEGURIDAD, 0, 5),
Propuesta("Creación del Instituto de Biotecnología e Investigaciones Científicas.", "", temas.SEGURIDAD, 0, 5),
Propuesta("Creación del Sistema de Emergencia Unificado.", "", temas.SEGURIDAD, 0, 5),
Propuesta("Recuperación de los centros culturales y cines de barrio.", "", temas.SALUD, 0, 5),
Propuesta("Fomento y fortalecimiento de la cultura popular, con el objetivo de recuperar el papel protagónico y creativo del Pueblo.", "", temas.SALUD, 0, 5),
Propuesta("Protección del patrimonio cultural de la Ciudad.", "", temas.SALUD, 0, 5),
...
Propuesta(" Incorporar al mercado los 370 mil inmuebles ociosos para abaratar el precio de los alquileres.","", temas.PLANEAMIENTO_URBANO, 5, 0),
Propuesta("Cobrar un impuesto progresivo a los grandes propietarios de viviendas ociosas que no las destinen a alquilar para aumentar el fondo destinado a créditos hipotecarios.","", temas.PLANEAMIENTO_URBANO, 5, 0),
Propuesta(" Flexibilizar los requisitos de acceso al crédito hipotecario para que cualquier familia trabajadora pueda tener una vivienda. Incrementar el presupuesto del IVC destinado a viviendas sociales.","", temas.PLANEAMIENTO_URBANO, 5, 0),
Propuesta(" Urbanizar integralmente las villas construyendo solo una vivienda por familia a pagar en cuotas, hospitales, escuelas y servicios básicos.","", temas.PLANEAMIENTO_URBANO, 5, 0),
...
Propuesta("Fortalecimiento de la producción de vivienda a través de formas cooperativas, autogestionarias y de empresas estatales.", "", temas.PLANEAMIENTO_URBANO, 8, 0),
Propuesta("Banco de inmuebles públicos y recuperación de tierras de la ciudad en manos del Estado Nacional para la asignación social.", "", temas.PLANEAMIENTO_URBANO, 8, 0),
Propuesta("Creación de una defensoría de inquilinos.", "", temas.PLANEAMIENTO_URBANO, 8, 0),
Propuesta("Relanzamiento de la Ley de Emergencia Habitacional para evitar desalojos.","", temas.PLANEAMIENTO_URBANO, 8, 0),
