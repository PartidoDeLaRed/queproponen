...
//Agregamos el nuevo
$match = "insert into tbCandidatos values (".($info['candID']+1).", '".utf8_decode($_GET['name'])."', '".utf8_decode($_GET['list'])."', '".utf8_decode($_GET['image'])."', '".$_GET['twitter']."', ".$_GET['cargo'].", ".$_GET['ciudad'].", ".$_GET['partido'].", ".$_GET['PASO'].", ".$_GET['ballotage'].");";
$qry = mysql_query($match)
or die ("No se pudieron encontrar datos porque ".mysql_error());
