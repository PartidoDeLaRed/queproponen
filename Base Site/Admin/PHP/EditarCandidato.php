...
$match = "update tbCandidatos set candNombre='".utf8_decode($_GET['name']).$agregarImagen."', candLista='".utf8_decode($_GET['list'])."', partID=".$_GET['partido'].", carID=".$_GET['cargo'].", ciuID=".$_GET['ciudad'].", candTwitter='".$_GET['twitter']."', candPASO=".$_GET['PASO']."', candBallotage=".$_GET['ballotage']." where candID = ".$_GET['codigo'].";";
		...
		array_push($propuestas,
			array (	'codigo'=> $propuesta['propID'],
					...
					'candidato' => array ('codigo' => $candidato['candID'],
										  ...
										  'ballotage' => $candidatos['candBallotage']
									)
					)
		);
	}
