...
$match = "update tbPropuestas set propTitulo='".utf8_decode($_GET['titulo'])."', propTexto='".utf8_decode($_GET['texto'])."', partID=".$_GET['partido'].", candID=".$_GET['candidato'].", catID=".$_GET['categoria']." where  propID=".$_GET['codigo']; 
