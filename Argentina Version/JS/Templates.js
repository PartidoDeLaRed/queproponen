			...
			categorias.forEach(function(cat){
				template += "<div class='versusCategoryContainer'>"+
					"<div id='"+cat.nombre+"' class='candidatoContainer_Header' style='border-top: 2px solid "+cat.color+"'>"+
						...
						"<div class='imagenCategoria' style='width: 60px; height: 60px; margin: 12px; background-image: url(http://queproponen.com.ar/argentina/IMG/categorias/"+cat.imagen+");'></div>"+
...
function HeaderPartido(part, chico, cantProps)
{
	...
	if(!chico)
	{
		...
		$(facebook).click(function(e) {
			...
			'&picture=http:%2F%2Fqueproponen.com.ar%2Fargentina%2FIMG%2FshareImage.png' +
